...
class run:
    ...
    def train(self, imagefolder, validfolder):
        ...
        with tf.Session(config=self.config) as sess:
            ...
            if not os.path.exists(self.ckpt_path):
                ...
                if os.path.isfile(self.ckpt_path + "checkPoint" + ".meta"):
                    if self.load_flag:
            ...
            for e in range(1, self.epochs+1):
                ...
                try:
                    while True:
                        ...
                        if step % 1000 == 0:
                            save_path = saver.save(sess, self.ckpt_path + "checkPoint")
    ...
    def upscale(self, path):
        ...
        with tf.Session(config=self.config) as sess:
            ...
            # load the model
            ckpt_name = self.ckpt_path + "checkPoint" + ".meta"
    ...
    def testFromPb(self, path):
        ...
        """
        # Read model
        pbPath = "./models/SCALED_x{}.pb".format(self.scale)
        ...
        with tf.Session(graph=graph) as sess:
            ...
            print("PSNR of Proposed  upscaled image: {}".format(self.psnr(cropped, HR_image)))
            print("PSNR of bicubic upscaled image: {}".format(self.psnr(cropped, bicubic_image)))

            cv2.imshow('Original image', fullimg)
            cv2.imshow('Proposed upscaled image', HR_image)
            cv2.imshow('Bicubic upscaled image', bicubic_image)

            cv2.imwrite("./images/ProposedOutput.png", HR_image)
    ...
    def export(self, quant):
        ...
        export_file = "SCALED_x{}.pb".format(self.scale)
        ...
        with graph.as_default():
            with tf.Session(config=self.config) as sess:
                ...
                if quant == 1:
                    ...
                    export_file = "SCALED_x{}_q1.pb".format(self.scale)
                if quant == 2:
                ...
                if quant == 3:
                    ...
                    export_file = "SCALED_x{}_q3.pb".format(self.scale)
